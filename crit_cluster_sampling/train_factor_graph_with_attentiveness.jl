...
"""
function AutoScenes.Vars(packedscene::AttentiveMobiusScene, roadway::MobiusRoadway, critical_cars::Vector{Int}=Int[])
...
function get_factorgraph(scene::AttentiveMobiusScene, roadway::MobiusRoadway, features)
